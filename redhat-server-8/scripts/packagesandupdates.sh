...
dnf -y install python3-policycoreutils selinux-policy-devel openldap-clients sssd sssd-ldap authconfig pam_ldap sssd-ad nfs-utils
...
dnf -y install perl open-vm-tools openssh chrony system-storage-manager #ntp
...
dnf -y install dconf audit cronie authconfig
