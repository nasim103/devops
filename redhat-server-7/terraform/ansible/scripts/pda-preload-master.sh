...
useradd -c "Saheed Salami - GTO Enterprise Security" -u 449285  -G wheel,cgitier1,securityeng -m -d /home/ssalami ssalami
useradd -c "Crystal Greene - GTO Enterprise Security" -u 215115  -G wheel,cgitier1,securityeng -m -d /home/cgreene cgreene
useradd -c "Michael Adesanya - GTO Enterprise Security" -u 470752  -G wheel,cgitier1,securityeng -m -d /home/madesanya madesanya
useradd -c "Ben Verlander - GTO Enterprise Security" -u 405119  -G wheel,cgitier1,securityeng -m -d /home/bverlander bverlander
...
usermod -p "PASSWORDINAD" ssalami
usermod -p "PASSWORDINAD" cgreene
usermod -p "PASSWORDINAD" madesanya
usermod -p "PASSWORDINAD" bverlander
...
chage -E -1 -I -1 -m -1 -M -1 ssalami
chage -E -1 -I -1 -m -1 -M -1 cgreene
chage -E -1 -I -1 -m -1 -M -1 madesanya
chage -E -1 -I -1 -m -1 -M -1 bverlander
