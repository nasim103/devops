...
git clone --depth 1 -b Develop https://packer:glpat-n8Zzemf47PV5Zx_Ag1o1@gitlab.css.cgipdc.cginet/unix-iac/aux/ad_realm_auth.git
...
authselect select custom/cis-profile with-faillock with-mkhomedir with-pamaccess
