...
echo '# Shared secret definition - should be the same as the one contained in' >> /apps/IPsoft/IPremote/etc/secret.cfg
echo '# check_IPremote.cfg' >> /apps/IPsoft/IPremote/etc/secret.cfg
echo 'secret=ipmonytor1ng7642' >> /apps/IPsoft/IPremote/etc/secret.cfg
