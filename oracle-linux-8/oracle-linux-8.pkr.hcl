# 
# Packer template for Oracle Linux 8 Server.
...
source "vsphere-iso" "oracle-linux-8" {
...
#https://serverfault.com/questions/1049693/oel8-kickstart-install-on-esxi-hangs-at-reached-target-basic-system-why
 cd_files = ["./configs/ks-oel8.cfg"] 
 cd_label = "autoinstall"
  boot_command = [
    "<up>",
    "e",
    "<down><down><end><wait>",
    "vmlinuz initrd=initrd.img ip=10.106.68.120::10.106.68.1:255.255.255.0:pranchrhel8tmp:ens224:none nameserver=10.0.3.72  nameserver=10.0.3.71 text inst.ks=cdrom:/ks-oel8.cfg",
...
build {
  sources = ["source.vsphere-iso.oracle-linux-8"]
  /*
